...
const Projects = () => {
  return (
    <main className="flex h-[calc(100%-64px)] flex-col justify-between gap-10 md:flex-row">
      <section className="flex w-full flex-col justify-center gap-10 md:w-2/5">
        <h1 className=" text-bold text-right text-5xl">
      ...
      <section className="relative mt-2 flex flex-col items-end gap-14 overflow-auto text-7xl font-light lg:text-8xl xl:text-9xl">
        <Link
          href="/about"
